...
export function FoodCard1({card, localFrame}: {card: CardSlot; localFrame: number}) {
  return (
...
export function FoodCard2({card, localFrame}: {card: CardSlot; localFrame: number}) {
  return (
...
export function FoodCard3({card, localFrame}: {card: CardSlot; localFrame: number}) {
  return (
    <div style={{...cardBase, background: '#d9dde0'}}>
      <ImageFill
        driftY={20}
...
export function FoodCard4({card, localFrame}: {card: CardSlot; localFrame: number}) {
  return (
    <div style={{...cardBase, background: '#d9dde0'}}>
      <div
        style={{
...
export function FoodCard5({card, localFrame}: {card: CardSlot; localFrame: number}) {
  return (
    <div style={{...cardBase, background: '#d9dde0'}}>
      <ImageFill
        driftX={-18}
...
export function FoodCard6({card, localFrame}: {card: CardSlot; localFrame: number}) {
...
type TemplateRenderProps = {
  ...
  card5?: CardSlot;
  card6?: CardSlot;
  workflow?: {cardCount?: number};
};

export const FOOD_CARD_COMPONENTS = [
  FoodCard2,
  FoodCard1,
  FoodCard3,
  FoodCard4,
...
export const ArmenianFoodCarousel: React.FC<TemplateRenderProps> = (props) => {
  ...
  const ActiveCard = [FoodCard2, FoodCard1, FoodCard3, FoodCard4, FoodCard5, FoodCard6][activeIndex] || FoodCard2;
