...
function pickCardComponent(card: CardSlot) {
  if (card.cardLayout === 'body-below') return BodyBelowCard;
  return HeadlineTopCard;
}
...
export const WizzLondonYerevanTemplate: React.FC<TemplateRenderProps> = (props) => {
  ...
  const ActiveCard = pickCardComponent(activeCard);
